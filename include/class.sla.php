...
include_once INCLUDE_DIR.'Services/SlaPriorityEscalationService.php';
...
implements TemplateVariable {
    ...
    function addGracePeriod(Datetime $date, BusinessHoursSchedule $schedule
        ...
        return (new SlaGracePeriodCalculator())->addGracePeriod(
    ...
    function isTransient() {
        return (new SlaTransientChecker())->isTransient($this->flags);
    }

    function sendAlerts() {
        return (new SlaSendAlertsChecker())->sendAlerts($this->flags);
    }
    ...
    function priorityEscalation() {
        return (new SlaPriorityEscalationService())->priorityEscalation($this->flags);
    }
