...
include_once INCLUDE_DIR.'Services/SlaPriorityEscalationChecker.php';
...
implements TemplateVariable {
    ...
    function addGracePeriod(Datetime $date, BusinessHoursSchedule $schedule
        ...
        return (new SlaGracePeriodCalculator())->addGracePeriod($date,
                $this->getGracePeriod(), $schedule, $timeline);
    }
    ...
    function priorityEscalation() {
        return (new SlaPriorityEscalationChecker())
            ->priorityEscalation($this->flags);
    }
