...
implements TemplateVariable {
    ...
    function addGracePeriod(Datetime $date, BusinessHoursSchedule $schedule
        ...
        return (new SlaGracePeriodCalculator())->addGracePeriod(
                $date, $schedule, $this->getGracePeriod(), $timeline);
    }
    ...
    function sendAlerts() {
        return (new SlaSendAlertsChecker())->sendAlerts(
    ...
    function priorityEscalation() {
        return (new SlaPriorityEscalationResolver())->isPriorityEscalationEnabled(
