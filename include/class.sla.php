...
implements TemplateVariable {
    ...
    function isTransient() {
        return (new SlaTransientChecker())->isTransient(
                $this->flags, self::FLAG_TRANSIENT);
    }

    function sendAlerts() {
        return (new SlaSendAlertsChecker())->isSendAlertsEnabled(
    ...
    function priorityEscalation() {
        return (new SlaPriorityEscalationChecker())->isPriorityEscalationEnabled(
