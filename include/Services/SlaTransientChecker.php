...
/*********************************************************************
    ...
    SLA::isTransient(). Flag loading and facade concerns stay with the
    caller.
...
class SlaTransientChecker {
     ...
     * @return bool True if FLAG_TRANSIENT is set in flags, false otherwise
     */
    public function check($sla) {
