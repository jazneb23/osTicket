...
include_once INCLUDE_DIR.'Services/TicketOverdueTransitions.php';
...
implements RestrictedAccess, Threadable, Searchable {
    ...
    function isOverdue() {
        return TicketOverdueTransitions::isOverdue($this);
    }
   ...
   function onOverdue($whine=true, $comments="") {
    ...
    function markOverdue($whine=true) {
        ...
        return TicketOverdueTransitions::markOverdue($this, $whine);
    }

    function clearOverdue($save=true) {
        return TicketOverdueTransitions::clearOverdue($this, $save);
    }
   ...
   /*============== Static functions. Use Ticket::function(params); =============nolint*/
    ...
    static function checkOverdue() {
        TicketOverdueTransitions::checkOverdue(static::class);
    }
